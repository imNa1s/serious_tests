...
@pytest.mark.on
def test_sub():
    request_link = Request_methods.sub_on_request_url(click_id)
...
@pytest.mark.off
def test_unsub():
    request_link = Request_methods.sub_off_request_url(click_id)
    request = BaseMt.just_click(request_link)
...
@pytest.mark.rebill
def test_rebill():
    request_link = Request_methods.sub_rebill_request_url(click_id)
    request = BaseMt.just_click(request_link)
