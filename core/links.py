class LinksReqTds:
    tds_click_test = 'http://test1.clicktds.ru/CX1wS_0-qf?debug_operator_id=1&tds_no_redirect=1'
    tds_click_test_1 = 'http://test1.clicktds.ru/-NHVooUv-w?debug_operator_id=1&tds_no_redirect=1'
